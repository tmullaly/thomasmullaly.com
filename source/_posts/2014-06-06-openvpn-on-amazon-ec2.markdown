...
categories: security
---
Create a new EC2 instance, I use the offical Amazon AMI images.
...
reboot
{% endhighlight %}
I don't know why I opened up these two files, I'm leaving this in here until I figure it out.
{% highlight bash %}
...
{% highlight bash %}
  ...
  156  history
{% endhighlight %}
Here's my OpenVPN 2.0 server config file:
{% highlight bash %}
